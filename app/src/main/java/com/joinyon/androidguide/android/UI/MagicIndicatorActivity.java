package com.joinyon.androidguide.android.UI;
...
import com.joinyon.androidguide.android.ColorFlipPagerTitleView;
import com.joinyon.androidguide.android.ExamplePagerAdapter;
import com.joinyon.androidguide.android.ScaleTransitionPagerTitleView;
...
/**
 * 几种常见的指示器  https://github.com/hackware1993/MagicIndicator
 */
    ...
    private void initMagicIndicator6() {
        ...
        commonNavigator.setAdapter(new CommonNavigatorAdapter() {
            ...
            public IPagerTitleView getTitleView(Context context, final int index) {
                ...
                simplePagerTitleView.setSelectedColor(Color.parseColor("#ff40c2fc"));
                simplePagerTitleView.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        mViewPager.setCurrentItem(index);
            ...
            public IPagerIndicator getIndicator(Context context) {
                LinePagerIndicator indicator = new LinePagerIndicator(context);
                indicator.setColors(Color.parseColor("#ff40c2fc"));
                return indicator;
            }
        });
        magicIndicator.setNavigator(commonNavigator);
