    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        newEditorPostEmpty.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                bundle.putString(EditorExampleActivity.TITLE_PLACEHOLDER_PARAM,
                        getString(R.string.example_post_title_placeholder));
                bundle.putString(EditorExampleActivity.CONTENT_PLACEHOLDER_PARAM, getString(R.string.example_post_content_placeholder));
                //bundle.putString(EditorExampleActivity.CONTENT_PLACEHOLDER_PARAM"");
        ...
        my.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MainExampleActivity.this, MyEditActivity.class);
                Bundle bundle = new Bundle();
                bundle.putString(MyEditActivity.CONTENT_PARAM, Utils.getHtmlFromFile(mActivity,
                        "example/example-content.html"));
                intent.putExtras(bundle);
                startActivity(intent);
            }
